...
This release focuses on correctness and bug fixes, which the majority of reporting and testing coming from the community. Much of the work was in service to Linkerd's Kubernetes and Consul support. Half of the changes in this release were community contributions, thanks!
...
* Kubernetes
  ...
  * Introduce a 'strict' Kubernetes ingress identifier that ignores default backends ([#1794](https://github.com/linkerd/linkerd/pull/1794)). Thanks to [@negz](https://github.com/negz)!
