...
- Admin
  - Add new io.l5d.marathon,  io.l5d.fs,  and  io.l5d.k8s.configMap watch state endpoints to allow
    diagnosis of Linkerd’s various watches.
- Distributed Tracing
  - Add a new io.l5d.zipkin trace propagation plugin that writes Zipkin B3 trace headers to outgoing
    requests. Previously, Zipkin trace headers were ignored by Linkerd in order for Linkerd to not 
    interfere with other tracing systems like Zipkin.
- Namerd
